...
var member = {
	...
	//이메일 입력 상태 확인
	emailStatus: function(email){ //@abc.co.kr @abc.com @abc.net ...
	...
	userid : {
		invalid: {is:false, desc: '영문 소문자나 숫자만 입력하세요'},
		valid: {is:true, desc: '아이디 중복확인하세요'},
		usable: {is:true, desc: '사용가능한 아이디입니다'},
		unUsable: {is:true, desc: '이미 사용 중인 아이디입니다'}
	},
	...
	//비밀번호를 다시 입력할 때 비밀번호 확인 항목을 초기화
